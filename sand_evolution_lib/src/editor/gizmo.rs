...
impl GizmoSystem {
    ...
    fn draw_scale_gizmo(painter: &Painter, pos: Pos2, active_handle: GizmoHandle) {
        ...
        // X axis
        let x_color = if active_handle == GizmoHandle::ScaleX || active_handle == GizmoHandle::ScaleXY {
            Color32::from_rgb(255, 200, 100)
        } else {
            Color32::from_rgb(255, 50, 50)
        };
        ...
        // Y axis
        let y_color = if active_handle == GizmoHandle::ScaleY || active_handle == GizmoHandle::ScaleXY {
            Color32::from_rgb(200, 255, 100)
        } else {
            Color32::from_rgb(50, 255, 50)
        };
