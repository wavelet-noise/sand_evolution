...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h01ea32c4a698ad61: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h11ddb691d12d990a: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures_____invoke__hfb3bc78558ecfa9c: (a: number, b: number) => void;
  readonly wasm_bindgen__closure__destroy__h26acb8ca76b3d3d3: (a: number, b: number) => void;
