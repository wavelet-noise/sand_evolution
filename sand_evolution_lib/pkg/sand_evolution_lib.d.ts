...
export interface InitOutput {
  ...
  readonly closure331_externref_shim: (a: number, b: number, c: any) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h0e0d5174d5d41c2a: (a: number, b: number) => void;
  ...
  readonly closure497_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure3700_externref_shim: (a: number, b: number, c: any, d: any) => void;
